...
namespace TetrisOyun
{
    class Sekil
    {
        ...
        /// <summary>
        /// Merkez, blokar ve tetromino parametre alarak nesneye özelliklerine set eder.
        /// </summary>
        /// <param name="Merkez"></param>
        /// <param name="Bloklar"></param>
        ...
        /// <summary>
        /// Çarpışma olmazsa true döner, olursa false
        /// </summary>
        /// <param name="hareketVek"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Çarpışma yoksa x ve y değerlerini artırır. (0,1,-1 gibi değerler hareketVek ile gelir)
        /// </summary>
        /// <param name="hareketVek"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Mevcut blokları temp değişkenine yedekleyip çevirir, çarpışma varsa yedeklenen bloklar set edilir false döner.
        /// </summary>
